...
export class ShiftsController {
  ...
  findAll(
    ...
    return this.shiftsService.findAll(currentUser, paginationDto, search, locationId, companyId, pharmacistId, shiftId, fromDate, toDate, minRate, maxRate, selectedStatus);
  }
